...
//import { GUI } from 'three/examples/jsm/libs/dat.gui.module.js'; // Use dat.gui module instead of lil-gui
//
...
//
//	const loader = new THREE.JSONLoader(); // Use JSONLoader for loading JSON data
//
//	loader.load('output.json', function (geometry) { // Load your JSON file containing point cloud data
//
//		const material = new THREE.PointsMaterial({ color: 0xffffff, size: 0.01 }); // Material for the point cloud
//
...
//		const gui = new GUI();
//
//		gui.add(material, 'size', 0.001, 0.01).onChange(render);
//		gui.addColor(material, 'color').onChange(render);
//		gui.open();
//
//		render();
//
